...
echo "[eval_student_2pt2_distilled] steps=$NUM_STEPS (high=$STEPS_HIGH low=$STEPS_LOW) | frames=$NUM_FRAMES | resolution=$RESOLUTION $ASPECT_RATIO | seed=$SEED | samples=$NUM_SAMPLES (first sample: warmup)"
