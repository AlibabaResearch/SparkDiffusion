...
from sparkdiffusion.utils.lr_scheduler import LambdaLinearScheduler, LambdaWarmUpCosineScheduler
...
def register_scheduler():
    ...
    cs.store(group="scheduler", package="scheduler", name="cosine", node=LambdaWarmUpCosineSchedulerConfig)
