...
def main(args):
    ...
    grid_rows = (num_videos + grid_cols - 1) // grid_cols  # ceiling division
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vae_path", type=str, default="pretrain_weights/Wan2.1-T2V-1.3B-Diffusers/vae", help="Path to the Wan2.1 VAE model weights.")
