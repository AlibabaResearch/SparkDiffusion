...
dit_configs = {
    "1.3B": WAN2PT1_1PT3B_T2V,
    "14B": WAN2PT1_14B_T2V,
    "1.3B_rola": WAN2PT1_1PT3B_T2V_ROLA,
    "14B_rola": WAN2PT1_14B_T2V_ROLA,
    "1.3B_pure_sla": WAN2PT1_1PT3B_T2V_PURE_SLA,
    "14B_pure_sla": WAN2PT1_14B_T2V_PURE_SLA,
}
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--dit_path", type=str, default="", help="Path to the video diffusion model.")
    ...
    parser.add_argument("--prompt", type=str, default=_DEFAULT_PROMPT, help="Text prompt for this inference case")
...
if __name__ == "__main__":
    ...
    all_text_embs = (
        get_umt5_embedding(checkpoint_path=args.text_encoder_path, prompts=prompts, tokenizer_path=args.tokenizer_path)
        .to(dtype=torch.bfloat16)
        .cuda()
    )
    neg_text_emb = (
        get_umt5_embedding(checkpoint_path=args.text_encoder_path, prompts=args.negative_prompt, tokenizer_path=args.tokenizer_path)
        .to(dtype=torch.bfloat16)
        .cuda()
    )
    clear_umt5_memory()

    # --- Sampler setup (shared across prompts) ---
