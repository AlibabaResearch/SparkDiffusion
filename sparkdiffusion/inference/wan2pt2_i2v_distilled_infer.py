...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Few-step distilled inference script for Wan2.2 I2V with High/Low Noise models")
    parser.add_argument("--image_path", type=str, required=True, help="Path to the input image for I2V generation.")
    parser.add_argument(
        "--high_noise_model_path", type=str, default="pretrain_weights/Wan2.2-I2V-A14B-high-distilled-merged.pth", help="Path to the high-noise model."
    )
    parser.add_argument(
        "--low_noise_model_path", type=str, default="pretrain_weights/Wan2.2-I2V-A14B-low-distilled-merged.pth", help="Path to the low-noise model."
    )
    ...
    parser.add_argument("--text_encoder_path", type=str, default="", help="Path to the umT5 text encoder.")
    parser.add_argument("--tokenizer_path", type=str, default="", help="Path to the umT5 tokenizer directory.")
