...
from sparkdiffusion.tokenizers.interface import VideoTokenizerInterface
...
class WanVAE_(nn.Module):
    ...
    def encode(self, x, scale):
        ...
        # Split the encode input x along time into chunks of 1, then self.temporal_window each.
